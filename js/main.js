...
(() =>{
    ...
    closeNavMenuBtn = navMenu.querySelector(".close-nav-menu");

    hamburgerBtn.addEventListener("click", showNavMenu);
    closeNavMenuBtn.addEventListener("click", hideNavMenu);
        ...
        document.addEventListener("click", (event)=>{
            if(event.target.classList.contains("link-item")){
                /* make sure event.target.hash has a value before overriddign default behavior */
                if(event.target.hash !==""){
                    // prevent default behavior when click anchor
                    ...
                    // if clicked 'linke-item' contained within the navigation menu
...
(() =>{
 ...
 (() =>{
  ...
  prevBtn.addEventListener("click",() =>{
    ...
    function slider(){
        // deactivate exitign active slides
